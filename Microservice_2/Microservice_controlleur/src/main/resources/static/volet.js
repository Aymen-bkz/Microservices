am5.ready(async function() {
    ...
    var root = am5.Root.new("chartdiv-v");
    ...
    var data = [{
        ...
        "value": volet_tab[0]["order"]
    }, {
        "id": "id " + volet_tab[1]["id"],
        "value": volet_tab[1]["order"]
    }, {
        "id": "id " + volet_tab[2]["id"],
        "value": volet_tab[2]["order"]
    }, {
        "id": "id " + volet_tab[3]["id"],
        "value": volet_tab[3]["order"]
    }];
