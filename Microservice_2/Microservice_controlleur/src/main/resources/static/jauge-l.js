am5.ready(function() {
    ...
    var root = am5.Root.new("chartdiv-l");
    ...
    var axis1 = createAxis(0, 600, -85, -5, am5.color(0xEF6F6C));
    var axis2 = createAxis(0, 600, 5, 85, am5.color(0x426A5A));
    var axis3 = createAxis(0, 600, 95, 175, am5.color(0x7FB685));
    var axis4 = createAxis(0, 600, 185, 265, am5.color(0xDDAE7E));
    ...
    setInterval(async function() {
        luminosite_tab = service_data[0];

        legands_tab.forEach((e, i) => {
            e.uid = luminosite_tab[i]["id"]
        })
